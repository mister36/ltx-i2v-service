...
app = FastAPI(title="LTX Video Generation Service", description="Video generation service using LTX Video models")
svc = None
...
async def health():
    ...
    return {"status": "healthy", "service": "LTX Video Generation"}
